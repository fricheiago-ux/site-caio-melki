...
- 2026-09-25 — Juntadas numa só branch as pendências locais de vários chats
  (branch `pendentes-25-09`, enviada pelo Iago do Mac) + a correção da
  digitação da hero. O chat "maestro" e esta sessão resolveram a digitação
  do mesmo jeito (aviso na metade das portas); ficou a versão com
  `portas:meio`, sem respiro extra (primeira letra a ~0,53s em vez de
  ~1,21s). Na revisão, um ajuste nos cards de formação: o Safari do iPhone
  deixa o `:hover` grudado no último card tocado, então o segundo toque
